<template>
    <div class="container-fluid"> <!--Welcome Title -->
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-12 col-md-10 col-lg-10 col-12 align-items-center justify-content-center">
                ...
                v-if="showMsg === 'new'"
                :value="true"> New customer has been added.
                </div>
                <div class="alert alert-success"
                v-if="showMsg === 'update'"
                :value="true"> Customer information has been updated.
                </div>
                <div class="alert alert-success"
                v-if="showMsg === 'deleted'"
                :value="true"> Selected customer has been deleted.
                </div>
            </div>
        </div>
        <!-- Data table -->
        <div class="row align-items-center justify-content-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <button @click="updateCustomer(customer)" style="background-color: transparent; padding: 0;">
                                ...
                                10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207
                            ...
                            viewBox="0 0 16 16">
                            <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1
                            0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0
                            1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0
            ...
            <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
                        ...
                        <tr v-for = "customer in customers" v-bind:key="customer">
                            ...
                            <td @click="updateCustomer(customer)">
                                <button style="background-color: transparent; padding: 0;">
                                    ...
                                    11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0
                                    1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528
                            ...
                            <td @click="deleteCustomer(customer)">
                                <button style="background-color: transparent; padding: 0;">
                                    ...
                                    class="bi bi-trash-fill"
                                    viewBox="0 0 16 16">
                                    <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0
                                    0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0
                                    0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3
                                    4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0
                                    0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0
                                    1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1
                ...
                @click="addNewCustomer">Add New Customer</button>
            </div>
        </div>
    </div>
</template>
