        ...
        <div class="row align-items-center justify-content-center">
            <div class="col col-12 col-sm-6 col-md-10 col-lg-6">
                <div class="card">
                    ...
                    role="alert"> Invalid username or password. Please Try again. </div>
                    <div class="p-2">
                    </div>
                    <div class="card-body">
                        <div class="row align-items-center justify-content-center"
                        v-if="loading"> <!-- Creating the progress bar -->
                        <div class="progress">
                    ...
                    <form v-else ref="form">
                        <div class="container-fuild">
                            ...
                            <div class="form-group row justify-content-left py-2">
                                ...
                                <div class="col col-8">
                                    <input v-model="credentials.password2"
                                    type="password"
                                    class="form-control-sm form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row justify-content-left py-2">
                                ...
                                <div class="col col-8">
                                    <input v-model="credentials.first_name"
                                    type="text"
                                    class="form-control-sm form-control">
                                </div>
                            </div>
                            <div class="form-group row justify-content-left py-2">
                                ...
                                <div class="col col-8">
                                    <input v-model="credentials.last_name"
                                    type="text"
                                    class="form-control-sm form-control">
                                </div>
                            </div>
