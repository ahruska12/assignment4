        ...
        <div class=" col align-items-center">
            <div class="row align-items-center justify-content-center">
                <div class="col col-12 col-sm-10 col-md-10 col-lg-6">
                    ...
                    role="alert"
                    v-if="showMsg === 'error'"> Please verify Investment Information
                    </div>
                </div>
            </div>
            <div class="row align-items-center justify-content-center">
                        ...
                        <form ref="form">
                            <div class="container-fluid">
                                <div class=" row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <select v-model="investment.customer"
                                        class="form-select">
                                        <option class ="form-select form-select-sm "
                                        v-for=" item in list"
                                        :value="item.pk"
                                        :key="item.pk"> {{item.name}} </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <input v-model="investment.category"
                                        type="text"
                                ...
                                <div class="form-group row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <input v-model="investment.description"
                                        type="text"
                                        class="form-control-sm form-control">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <input v-model="investment.acquired_value"
                                        type="number"
                                        class="form-control-sm form-control">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <input v-model="investment.acquired_date"
                                        type="date"
                                        class="form-control-sm form-control">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <input v-model="investment.recent_value"
                                        type="number"
                                        class="form-control-sm form-control">
                                    </div>
                                </div>
                                <div class="form-group row justify-content-around py-2">
                                    ...
                                    <div class="col col-8">
                                        <input v-model="investment.recent_date"
                                        type="date"
                                        class="form-control-sm form-control">
                                    </div>
                                </div>
